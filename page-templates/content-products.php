	...
	<div class="wrapper">
		...
		<div class="cards">
			...
			<div class="card">
				...
				<p class="card-content">Potrzebujesz rozłożyć płatność w czasie? Nie ma problemu! Możesz zapłacić w trzech ratach - pierwszej <strong>do 7 dni od zamówienia</strong> (najpóźniej do 22 maja) i kolejnych do <strong>20 czerwca</strong> i <strong>20 lipca</strong>! Dokładne kwoty znajdziesz w <a href="<?php echo site_url('/cennik'); ?>" title="Cennik">Cenniku</a>.</p>
			</div>
		</div>
		<div class="cards">
			<div class="card">
